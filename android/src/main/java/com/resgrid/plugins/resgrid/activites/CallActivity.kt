...
import com.resgrid.plugins.resgrid.databinding.CallActivityBinding
import com.resgrid.plugins.resgrid.dialog.showDebugMenuDialog
import com.resgrid.plugins.resgrid.dialog.showSelectAudioDeviceDialog
import com.resgrid.plugins.resgrid.viewModelByFactory
...
class CallActivity : AppCompatActivity() {
    ...
    val viewModel: CallViewModel by viewModelByFactory {
        val arg = intent.getStringExtra(CallActivity.KEY_ARGS)
                ?: throw NullPointerException("args is null!")
        val gson = Gson()

        //CallViewModel(gson.fromJson(arg, ConfigData::class.java), application)
        CallViewModel(application)
    }
